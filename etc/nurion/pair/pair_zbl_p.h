...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(zbl/pair,PairZBLp);
// clang-format on
#else

#ifndef LMP_PAIR_ZBL_HT
#define LMP_PAIR_ZBL_HT

#include "pair.h"

namespace LAMMPS_NS {

class PairZBLp : public Pair {
 public:
  PairZBLp(class LAMMPS *);
  virtual ~PairZBLp();
 ...
 protected:
  ...
  //Memory for distance 
  double **outer_dist, **inner_dist;
  double **outer_sq, **inner_sq;
  ...
  // For pair ZBL
  void set_coeff(int, int, double, double, double, double);
};
}    // namespace LAMMPS_NS
