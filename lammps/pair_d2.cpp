...
void PairD2::compute(int eflag, int vflag) {
  ...
  /* if (comm->me == 0) { */
  /*   fprintf(lmp->logfile, "value of type[i] in rank_root\n"); */
  /*     for (int my_idx_1 = 0; my_idx_1 < atom->natoms; my_idx_1++) { */
  /*       fprintf(lmp->logfile, "%d %d\n", my_idx_1, atom->type[my_idx_1]); */
  /*     } */
  /*   fprintf(lmp->logfile, "value of x[i] in rank_root\n"); */
  /*     for (int my_idx_1 = 0; my_idx_1 < atom->natoms; my_idx_1++) { */
  /*         for (int my_idx_2 = 0; my_idx_2 < 3; my_idx_2++) { */
  /*           fprintf(lmp->logfile, "%f ", x[my_idx_1][my_idx_2]); */
  /*         } */
  /*       fprintf(lmp->logfile, "\n"); */
  /*     } */
  /* } */
